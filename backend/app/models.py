...
class Device(Base):
    ...
    claim_consumed_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True)
    transfer_code_hash: Mapped[str | None] = mapped_column(String(64), nullable=True)
    transfer_expires_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True)
